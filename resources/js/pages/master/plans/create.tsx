...
export default function Create({ availableFeatures }: Props) {
                    ...
                    <div className="grid gap-6 lg:grid-cols-2">
                        ...
                        <Card>
                            <CardHeader className="border-b bg-muted/30">
                                ...
                                <CardDescription>
                                    Define the plan's name and description
                                </CardDescription>
                            </CardHeader>
                        ...
                        <Card>
                            <CardHeader className="border-b bg-muted/30">
                                ...
                                <CardDescription>
                                    Set the monthly and yearly prices
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4 p-6">
                                <div className="space-y-2">
                        ...
                        <Card>
                            <CardHeader className="border-b bg-muted/30">
                                ...
                                <CardDescription>
                                    Set usage limits (use -1 for unlimited)
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4 p-6">
                                <div className="grid gap-4 sm:grid-cols-2">
